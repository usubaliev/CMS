...
?>
        <form action="" method='post'>
            <table class="table table-bordered table-hover">
                ...
                <div class="col-xs-4" style="padding:0 0 20px 20px;">
...
//                  echo "<td><a href='comments.php?approve=$comment_id'>Approve</a></td>";
                    echo "<td><a href='post-comments.php?approve=$comment_id&id=" . $_GET['id'] ."'>Approve</a></td>";

//                  echo "<td><a href='comments.php?unapprove=$comment_id'>Unapprove</a></td>";
                    echo "<td><a href='post-comments.php?unapprove=$comment_id&id=" . $_GET['id'] ."'>Unapprove</a></td>";
                    
                    echo "<td><a href='post-comments.php?delete=$comment_id&id=" . $_GET['id'] ."'>Delete</a></td>";
...
<?php
        if(isset($_GET['approve'])){
            ...
            header("Location: post-comments.php?id=" . $_GET['id'] ."" );
        }
